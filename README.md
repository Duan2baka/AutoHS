...
4. 若要启动脚本，将当前目录切换到`AutoHS/`下（重要），运行`python main.py`即可。
   
   ***也可以双击run.bat执行，若遇中文乱码可以右键控制台更改字体为仿宋来解决***

   注意以下几点： 
   - **显示分辨率**（在桌面右击的显示设置里调整）以及**炉石分辨率**为**1920 * 1080**。 ***update 2022/5/26 只改游戏的分辨率应该就可以***
...
```
AAEDAePjAwS5oQTcoQTGogSWowQNl5YEnZYEr5YEsJYEsJcEsaEEsqEEvaEE0KEE1aEEk6IE1KIEw6MEAA==
```
